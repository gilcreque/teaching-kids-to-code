...
PROJECT_NAME = 'Teaching Kids to Code'
...
REPOSITORY_NAME = 'teaching-kids-to-code'
REPOSITORY_URL = 'git@github.com:gilcreque/%s.git' % REPOSITORY_NAME
REPOSITORY_ALT_URL = None # 'git@bitbucket.org:nprapps/%s.git' % REPOSITORY_NAME'

# The name to be used in paths on the server
# NOTE: This has been hacked to include a dash, so it can be used for assets in this project. It normally would be an underscore!
PROJECT_FILENAME = 'kids-code'

"""
DEPLOYMENT
"""
PRODUCTION_S3_BUCKETS = ['teachingkidstocode.report']
STAGING_S3_BUCKETS = ['staging.teachingkidstocode.report']
ASSETS_S3_BUCKET = 'assets.teachingkidstocode.report'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1RPUygDxr084nFZ5bbwOUOZ5nRoAzc3miKykVfI8w9I0'
